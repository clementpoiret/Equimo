...
def trace_model_divergence(jax_model, pt_model, arr, key):
...
# trace_model_divergence(eupe, torch_model, arr, key)
...
# pt_out, jax_out, pt_mod, jax_mod = trace_model_divergence(eupe, torch_model, arr, key)
...
def main():
    ...
    for name, path in weights.items():
        ...
        eupe = models[name](act_layer="exactgelu")
        ...
        torch_whitelist = []
        jax_whitelist = ["local_pos_embed.freqs"]
